...
const Card = ({ title, des, icon }) => {
  return (
    <div className="transform scale-y-100 hover:scale-y-105 transition-transform duration-300">
      <div className="w-50 h-36 ml-4 px-6 py-4 rounded-lg shadow-shadowOne flex items-center bg-gradient-to-b from-bodyColor to-[#b5b5b5] group hover:bg-gradient-to-b hover:from-[#dedede] hover:to-[#b6b6b6] transition-colors duration-100 group">
