    ...
    <div className="w-[100%] px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-8">
        ...
        <Card
          ...
          des="IT Project Management holds a special place in my journey, shaped by my experiences in diverse technology projects during my courses. Guiding projects to successful completion, collaborating, and ensuring optimal resource allocation have been valuable in improving my skills in project management. The opportunity to lead teams, and deliver impactful results is what drives my passion for IT Project Management."
          icon={<FaGlobe />}
        />
      </div>
    </div>
